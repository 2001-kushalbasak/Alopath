...
<html>
<head>
    <title>REGISTERED CARDIOLOGITS</title>
    <style>
    body
        {
            background: skyblue;
        ...
        overflow: hidden;
        white-space: nowrap;
        animation: text 2s steps(100) infinite;
...
$query = "SELECT * FROM `doc_list` WHERE specialization ='cardio'";
...
<h2 style="font-size:240%;" align="center"><mark>List Of Cardiologists</mark></h2>
